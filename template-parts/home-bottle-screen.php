<?php
    ...
    <div class="bottle-screen" data-model="<?php echo $model['url']; ?>" style="--bg-opacity: 0; --color-1: <?php echo $first_product_colors[0]; ?>; --color-2:  <?php echo $first_product_colors[1]; ?>; --color-3: <?php echo $first_product_colors[2]; ?>; --color-4: <?php echo $first_product_colors[3]; ?>;">
        ...
        <div class="bottle-screen__ctas">
            <button class="btn btn--dark-neg prev-next prev-next--prev" data-text="Prev"><span>Prev</span></button>
                <a href="<?php echo $first_product_permalink; ?>" class="btn btn--dark-neg" title="See Product" data-text="See Product"><span>See Product</span></a>
            <button class="btn btn--dark-neg prev-next prev-next--next" data-text="next"><span>next</span></button>
        </div>
    </div>