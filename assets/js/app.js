$(document).ready(function () {
    ...
    function intro(){
        ...
        // if($('.header--home').length){
            ...
            var drawCurtainLogo = gsap.timeline({
                defaults: { ease: 'linear' }, // Set default easing for all tweens
                // ease: 'expo.out' // Ease applied to the whole timeline
                ease: 'expo.inOut'
            });
            ...
            drawCurtainLogo .from('.curtain__logo__line--1', {duration: .5, drawSVG: 0})
                            .from('.curtain__logo__line--2', {duration: .5, drawSVG: 0}, '-=.05');
